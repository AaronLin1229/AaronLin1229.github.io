 ...
 */
!function(e,t){var r=t.documentElement,i="Fluid_Color_Scheme",a="--color-mode",o="data-user-color-scheme",n="data-default-color-scheme",c="#color-toggle-icon";function u(e){try{return localStorage.getItem(e)}catch(e){return null}}function s(){var e=getComputedStyle(r).getPropertyValue(a);return"string"==typeof e?e.replace(/["'\s]/g,""):null}function l(){r.setAttribute(o,g()),function(e){try{localStorage.removeItem(e)}catch(e){}}(i)}var d={dark:!0,light:!0};function g(){
// 取默认字段的值
...
e=f[s()])}return function(e,t){try{localStorage.setItem(e,t)}catch(e){}}(i,e),e}m(),Fluid.utils.waitElementLoaded(c,(function(){m();var e=t.querySelector("#color-toggle-btn");if(e){
// 当用户点击切换按钮时，获得新的显示模式、写入 localStorage、并在页面上生效
e.addEventListener("click",(function(){m(v())}));var r=t.querySelector(c);r&&(
// 光标悬停在按钮上时，切换图标
e.addEventListener("mouseenter",(function(){var e=r.getAttribute("data");r.classList.replace(h(f[e]),h(e))})),e.addEventListener("mouseleave",(function(){var e=r.getAttribute("data");r.classList.replace(h(e),h(f[e]))})))}}))}(window,document);